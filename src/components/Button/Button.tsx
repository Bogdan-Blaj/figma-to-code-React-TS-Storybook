...
export const Button = ({
  ...
  const ButtonVarianClassName = ButtonVariantClasses[variant];
  ...
  return (
    <button
      ...
      className={classNames("btn-base", className, {
        ...
        [classNames(
          ButtonVarianClassName.default,
          ButtonVarianClassName.hover,
          ButtonVarianClassName.focus
        )]: !disabled,
        [classNames(ButtonVarianClassName.disabled, "cursor-not-allowed")]:
          disabled,
      })}
    >
      {LeadingIcon ? (
